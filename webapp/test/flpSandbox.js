		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comlab2devfirstapplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devfirstapplication-display": {
								"semanticObject": "comlab2devfirstapplication",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.firstapplication",
									"url": sap.ui.require.toUrl("com/lab2dev/firstapplication")
								}
							}
						}
					}
